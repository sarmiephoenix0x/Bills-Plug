...
class PaymentSuccessfulAccount extends StatefulWidget {
  final int id;
  ...
  const PaymentSuccessfulAccount(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulAccount> createState() =>
      _PaymentSuccessfulAccountState();
}

class _PaymentSuccessfulAccountState extends State<PaymentSuccessfulAccount>
