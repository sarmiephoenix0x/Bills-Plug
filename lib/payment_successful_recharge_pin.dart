...
class PaymentSuccessfulRechargePin extends StatefulWidget {
  final int id;
  final String name;
  final String number;
  final String amount;
  final String timeStamp;
  const PaymentSuccessfulRechargePin(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulRechargePin> createState() =>
      _PaymentSuccessfulRechargePinState();
}

class _PaymentSuccessfulRechargePinState
    extends State<PaymentSuccessfulRechargePin> with TickerProviderStateMixin {
  String? profileImg;
  bool network = true;
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: basicInfo2(
                                              "Message",
                                              "Your Airtime Pin will be sent to your phone number within 1 hour",
                                              false),
                                        ),
                                      ],
                                    ),
