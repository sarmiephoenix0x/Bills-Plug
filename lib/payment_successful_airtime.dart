...
class PaymentSuccessfulAirtime extends StatefulWidget {
  final int id;
  ...
  const PaymentSuccessfulAirtime(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulAirtime> createState() =>
      _PaymentSuccessfulAirtimeState();
}

class _PaymentSuccessfulAirtimeState extends State<PaymentSuccessfulAirtime>
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: basicInfo2(
                                              "Message",
                                              "Successfully purchase ${widget.network} VTU to ${widget.number}.",
                                              false),
                                        ),
                                      ],
                                    ),
