...
class PaymentSuccessfulAirtime2cash extends StatefulWidget {
  final int id;
  ...
  const PaymentSuccessfulAirtime2cash(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulAirtime2cash> createState() =>
      _PaymentSuccessfulAirtime2cashState();
}

class _PaymentSuccessfulAirtime2cashState
    extends State<PaymentSuccessfulAirtime2cash> with TickerProviderStateMixin {
  String? profileImg;
  bool network = true;
                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo(
                                              "Inbound", widget.inbound, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo("Bank Name",
                                              widget.bankName, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo("Account Number",
                                              widget.accountNumber, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo("Account Name",
                                              widget.accountName, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
