...
class PaymentSuccessfulExamPin extends StatefulWidget {
  final int id;
  final String type;
  ...
  const PaymentSuccessfulExamPin(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulExamPin> createState() =>
      _PaymentSuccessfulExamPinState();
}

class _PaymentSuccessfulExamPinState extends State<PaymentSuccessfulExamPin>
                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo(
                                              "Exam Type", widget.type, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo(
                                              "Quality", widget.quality, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                        ...
                                        Padding(
                                          ...
                                          child: basicInfo2(
                                              "Message",
                                              "Your ${widget.type} Pin will be sent to phone number within 1 hour",
                                              false),
                                        ),
                                      ],
                                    ),
