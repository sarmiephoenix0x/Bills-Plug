...
import 'package:bills_plug/payment_successful_betting.dart';
...
class BettingWalletState extends State<BettingWallet>
  ...
  String providerImg = "images/SportyBet.png";
  String providerText = "Sporty Bet";
  ...
  void initState() {
    super.initState();
    idController.addListener(validateForm);
  ...
  void handlePinInputComplete(String code) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PaymentSuccessfulBetting(
          key: UniqueKey(),
          id: 0,
          betId: idController.text.trim(),
          type: providerText,
