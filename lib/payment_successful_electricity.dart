...
class PaymentSuccessfulElectricity extends StatefulWidget {
  final int id;
  final String number;
  final String type;
  final String amount;
  final String timeStamp;
  const PaymentSuccessfulElectricity(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulElectricity> createState() =>
      _PaymentSuccessfulElectricityState();
}

class _PaymentSuccessfulElectricityState
    extends State<PaymentSuccessfulElectricity> with TickerProviderStateMixin {
  String? profileImg;
  bool network = true;
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: basicInfo2(
                                              "Message",
                                              "Your Electricity bill for ${widget.number} has been sent and received within 1 hour",
                                              false),
                                        ),
                                      ],
                                    ),
