...
class PaymentSuccessfulCabletv extends StatefulWidget {
  final int id;
  final int iucNumber;
  final String type;
  final String plan;
  ...
  const PaymentSuccessfulCabletv(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulCabletv> createState() =>
      _PaymentSuccessfulCabletvState();
}

class _PaymentSuccessfulCabletvState extends State<PaymentSuccessfulCabletv>
