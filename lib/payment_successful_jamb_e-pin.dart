...
class PaymentSuccessfulJambEPin extends StatefulWidget {
  final int id;
  ...
  const PaymentSuccessfulJambEPin(
      {super.key,
      required this.id,
  ...
  @override
  State<PaymentSuccessfulJambEPin> createState() =>
      _PaymentSuccessfulJambEPinState();
}

class _PaymentSuccessfulJambEPinState extends State<PaymentSuccessfulJambEPin>
                                    ...
                                    child: Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo("Jamb Profile Code",
                                              widget.profileCode, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                          child: basicInfo(
                                              "Jamb Type", widget.type, false),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0, vertical: 12.0),
                                        ...
                                        Padding(
                                          ...
                                          child: basicInfo2(
                                              "Message",
                                              "Your ${widget.type} Pin will be sent to your phone number within 1 hour",
                                              false),
                                        ),
                                      ],
                                    ),
